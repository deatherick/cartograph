...
export function EntityDetail({
  ...
  useEffect(() => {
    ...
    setError(null)
    api
      .inspect(project, entity.Name, entity.Anchor.File)
      .then(setInsp)
      .catch((e) => setError(e instanceof Error ? e.message : String(e)))
  }, [entity.ID, entity.Name, entity.Anchor.File, project])
    ...
    <div className="p-4 overflow-y-auto h-full">
      ...
      <div className="flex gap-2 mb-4">
        <Button
          size="sm"
          variant="secondary"
          onClick={async () => setSource((await api.source(project, insp.Entity.Name, insp.Entity.Anchor.File)).source)}
        >
          Source
        </Button>
        <Button
